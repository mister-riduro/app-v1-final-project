...
import com.example.final_project.ui.activities.DetailEventActivity
...
////
////                    intent.putExtra(DetailEventActivity.EXTRA_NAME, this.event_name)
////                    intent.putExtra(DetailEventActivity.EXTRA_DATE, this.event_date)
////                    intent.putExtra(DetailEventActivity.EXTRA_LOCATION, this.event_loc)
////                    intent.putExtra(DetailEventActivity.EXTRA_DESC, this.event_desc)
////                    intent.putExtra(DetailEventActivity.EXTRA_TYPE, this.event_type)
////                    intent.putExtra(DetailEventActivity.EXTRA_BG, this.background)
//
